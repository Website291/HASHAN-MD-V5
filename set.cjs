...
const config = {
  SESSION_ID: process.env.SESSION_ID || "U4ZGEazB#2LCozvQU4nOBUM4x0AxaH4vOd5GkzJJEvoVjJG6lNKc",
  ...
  STATUS_READ_MSG: process.env.STATUS_READ_MSG || '✅️ Status Viewed by hashan-Md',
  ...
  SUDO_NUMBERS: process.env.SUDO_NUMBERS || "94706042889,94713520744",
